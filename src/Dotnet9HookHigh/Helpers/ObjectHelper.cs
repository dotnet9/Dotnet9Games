...
namespace Dotnet9HookHigh.Helpers
{
    internal static class ObjectHelper
    {
        ...
        internal static T Property<T>(this object obj, string propertyName, BindingFlags flags)
        {
            var type = obj.GetType();
            var fieldInfo = type.GetProperty(propertyName, flags);
